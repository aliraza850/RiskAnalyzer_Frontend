import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, isRef, shallowRef, isReadonly, isShallow, isReactive, toRaw, computed, defineAsyncComponent, unref, mergeProps, useSSRContext, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "C:/Users/Ali Raza/Desktop/AI_Simulator/risk-analyzer/frontend/node_modules/ofetch/dist/node.mjs";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index-VrEAJqBP.js"),
    children: [
      {
        name: "index",
        path: "",
