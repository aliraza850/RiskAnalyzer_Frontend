<template>
  <div class="fade-in-up" v-if="report">
    ...
    <div class="glass-panel rounded-2xl mb-margin p-8 md:p-10 overflow-hidden relative border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
      ...
      <div class="flex flex-col lg:flex-row lg:items-start justify-between gap-8 relative z-10">
        <div class="space-y-6 flex-1">
          ...
          <div class="space-y-2">
            ...
            <p class="text-outline font-body-lg text-lg opacity-80 max-w-2xl">
              Comprehensive threat analysis and vulnerability assessment generated by Gemini AI Engine.
            </p>
          </div>

          <div class="flex flex-wrap items-center gap-6 font-data-mono text-xs text-outline pt-4 border-t border-white/5">
            <div class="flex items-center gap-2 px-3 py-1 rounded-md bg-white/5">
        ...
        <div class="flex flex-col items-center justify-center gap-4 lg:min-w-[240px]">
          <div class="relative w-40 h-40 md:w-48 md:h-48 flex flex-col items-center justify-center rounded-full border-8 border-white/5 shadow-[0_0_50px_rgba(0,0,0,0.5)] bg-black/40 backdrop-blur-xl group" :class="getRiskColorClass(report.overallScore, 'border')">
            <div class="absolute inset-0 rounded-full bg-gradient-to-tr from-transparent via-transparent opacity-20 group-hover:opacity-40 transition-opacity" :class="getRiskColorClass(report.overallScore, 'bg')"></div>
            <span class="font-display-lg text-5xl md:text-6xl leading-none text-glow-cyan z-10" :class="getRiskColorClass(report.overallScore, 'text')">{{ report.overallScore }}</span>
            <span class="font-label-caps text-[10px] opacity-70 tracking-[0.3em] uppercase mt-2 z-10">Risk Index</span>
